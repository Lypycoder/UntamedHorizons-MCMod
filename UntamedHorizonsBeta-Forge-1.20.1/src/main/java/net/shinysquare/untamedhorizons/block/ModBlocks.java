package net.shinysquare.untamedhorizons.block;
...
import net.shinysquare.untamedhorizons.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, UntamedHorizons.MOD_ID);

    public static final RegistryObject<Block> HARDSTONE = registerBlock("hard_stone",
